...
<p>We endeavor to be available during posted business hours. Services may be unavailable due to equipment failures, maintenance, network issues, or circumstances beyond our control.</p>

<h2>9. Communications Consent</h2>
<p>By submitting contact information, you consent to receive communications related to your purchase inquiry. Opt out anytime by contacting <a href="mailto:<?php echo SITE_EMAIL; ?>"><?php echo SITE_EMAIL; ?></a> or calling <a href="tel:<?php echo SITE_PHONE_RAW; ?>"><?php echo SITE_PHONE; ?></a>.</p>

<h2>10. Website Use</h2>
<p>You may view Site content for personal or business informational purposes only. Unauthorized reproduction, distribution, or modification is prohibited. Content is protected by copyright and trademark law.</p>
...
<p>ALL PRODUCTS AND SERVICES ARE PROVIDED "AS IS" WITHOUT WARRANTIES OF ANY KIND, EXPRESS OR IMPLIED. WE DO NOT WARRANT THAT SOFTWARE WILL BE ERROR-FREE OR MEET YOUR SPECIFIC REQUIREMENTS BEYOND THE MANUFACTURER'S STATED SPECIFICATIONS. SOME JURISDICTIONS DO NOT ALLOW EXCLUSION OF IMPLIED WARRANTIES, SO THESE EXCLUSIONS MAY NOT APPLY TO YOU.</p>

<h2>15. Limitation of Liability</h2>
<p>UNDER NO CIRCUMSTANCES SHALL <?php echo strtoupper(SITE_LEGAL_NAME); ?> BE LIABLE FOR INDIRECT, INCIDENTAL, CONSEQUENTIAL, SPECIAL, OR PUNITIVE DAMAGES. OUR TOTAL LIABILITY SHALL NOT EXCEED THE AMOUNT PAID FOR THE SPECIFIC PRODUCT IN QUESTION. SOME STATES DO NOT ALLOW THESE LIMITATIONS.</p>
...
Phone: <a href="tel:<?php echo SITE_PHONE_RAW; ?>"><?php echo SITE_PHONE; ?></a><br>
